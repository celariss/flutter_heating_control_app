/// This file defines helpers for localizations/internationalization management
/// 
/// Authors: Jérôme Cuq
...
/// Put _navigatorKey as navigationKey of your Material :
/// MaterialApp(
...
AppLocalizations wcLocalizations() {
...
class Languages {
  static Map<String,String>? getNameFromCode(String languageCode) {
  ...
  static Map<String,String>? getNameFromLocale(Locale locale) {
    return getNameFromCode(locale.languageCode);
  }
